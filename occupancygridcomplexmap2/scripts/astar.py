...
def sample_deko(occupancy_grid):
    ...
    while not rospy.is_shutdown():
        ...
        occupancy_numberx, occupancy_numbery, occupancy_number  = find_point_in_occupancygrid(msg2.pose.position.x, msg2.pose.position.y, occupancy_grid.info.resolution, occupancy_grid.info.width, occupancy_grid.info.height, occupancy_grid.info.origin.position.x, occupancy_grid.info.origin.position.y)        
        print("occupancy number : " , occupancy_number)
        print("occupancy numberx : " , occupancy_numberx)
        print("occupancy numbery : " , occupancy_numbery)
